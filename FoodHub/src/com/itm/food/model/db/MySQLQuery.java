...
public class MySQLQuery {
	...
	public static String SQL_CUSTOMER_INSERT = "INSERT INTO ofod.ofod_customer(FIRST_NAME, LAST_NAME, DOB, PHONE, "
			+ "EMAIL, USERNAME, PASSWORD) VALUES (?,?,?,?,?,?,?)";

	public static String SQL_CUSTOMER_SELECT = "SELECT * FROM ofod.ofod_customer WHERE CUSTOMER_ID=?";

	public static String SQL_CUSTOMER_ADDRESS_INSERT = "INSERT INTO ofod.ofod_caddress(CUSTOMER_ID,FIRST_NAME,LAST_NAME,ADDRESS1,"
	...
	public static String SQL_PAYMENT_INSERT = "INSERT INTO ofod.ofod_payment(CUSTOMER_ID,CARD_NO,EXPIRY,CARD_TYPE,NAME_ON_CARD)"
			+ " VALUES (?,?,?,?,?)";
	...
	public static String SQL_FETCH_ITEMS_LIST = "SELECT I.ITEM_ID,ITEM_NAME,ITEM_DESCRIPTION,ITEM_PRICE,AVG(UR.RATING) AS RATING,RESTAURANT_ID "
			+ "FROM ofod.ofod_item I " + "LEFT JOIN ofod.ofod_item_rating IR ON IR.ITEM_ID = I.ITEM_ID "
			+ "LEFT JOIN ofod.ofod_user_rating UR ON UR.RATING_ID = IR.RATING_ID " + "WHERE RESTAURANT_ID = ? "
			+ "GROUP BY I.ITEM_ID " + "ORDER BY RATING DESC";

	public static String SQL_INSERT_INTO_ORDER = "INSERT INTO ofod.ofod_order (CUSTOMER_ID,CARD_ID,ADDRESS_ID,TOTAL_PAYMENT,ORDER_TIME,ORDER_STATUS,DRIVER_ID,"
	...
	public static String SQL_ORDER_ITEM_RESTAURANT_DETAILS_FETCH_QUERY = "SELECT R.RESTAURANT_ID,R.RESTAURANT_NAME,"
			...
			+ "LEFT JOIN ofod.ofod_coupon C ON C.COUPON_ID = OI.COUPON_ID " + " WHERE O.ORDER_ID = ?";
	...
	public static String SQL_ORDER_INSERT = "INSERT INTO ofod.ofod_order (CUSTOMER_ID, CARD_ID, ADDRESS_ID, TOTAL_PAYMENT, ORDER_TIME, ORDER_STATUS, "
	...
	public static String SQL_FETCH_TOP_3_RESTAURANTS = "SELECT R.RESTAURANT_ID,RESTAURANT_NAME,DESCRIPTION,ADDRESS1,ADDRESS2,CITY,ZIPCODE,PHONE, EMAIL, AVG(UR.RATING) AS RATING "
			+ "FROM ofod.ofod_restaurant R "
			+ "LEFT JOIN  ofod.ofod_restaurant_rating RR ON R.RESTAURANT_ID = RR.RESTAURANT_ID "
			+ "LEFT JOIN ofod.ofod_user_rating UR ON UR.RATING_ID = RR.RATING_ID " + "GROUP BY R.RESTAURANT_ID "
			+ "ORDER BY RATING DESC LIMIT 3;";

	public static String SQL_FETCH_ALL_COUPONS = "SELECT COUPON_ID,COUPON_CODE,COUPON_DESCRIPTION,COUPON_TYPE,COUPON_VALUE,COUPON_VALIDITY FROM ofod.ofod_coupon;";

	public static String SQL_FETCH_SELECTED_COUPON = "SELECT COUPON_ID,COUPON_CODE,COUPON_DESCRIPTION,COUPON_TYPE,COUPON_VALUE,COUPON_VALIDITY FROM ofod.ofod_coupon"
			+ " WHERE COUPON_CODE = ? ;";

	public static String SQL_USER_RATING_INSERT = "INSERT INTO ofod.ofod_user_rating(CUSTOMER_ID,RATING) VALUES(?,?)";

	public static String SQL_RESTAURANT_RATING_INSERT = "INSERT INTO ofod.ofod_restaurant_rating(RATING_ID,RESTAURANT_ID) VALUES(?,?)";

	public static String SQL_ITEM_RATING_INSERT = "INSERT INTO ofod.ofod_item_rating(RATING_ID, ITEM_ID) VALUES(?,?)";
