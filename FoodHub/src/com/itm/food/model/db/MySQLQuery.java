...
public class MySQLQuery {
	...
	public static String SQL_GET_RESTAURANTS_BY_ZIP = "SELECT RESTAURANT_ID,RESTAURANT_NAME,ADDRESS1,ADDRESS2,CITY,RATING,"
			+ "PHONE,EMAIL FROM ofod.ofod_restaurant WHERE ZIPCODE = ?";
