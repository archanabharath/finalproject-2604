...
public abstract class BaseController {
	...
	void handleOrders() {
		this.launchScene("Orders Screen", "/com/itm/food/views/Orders.fxml", BaseController.MAIN_SCREEN_WIDTH,
				BaseController.MAIN_SCREEN_HEIGHT);
	}

	void handleBasket() {
		this.launchScene("Basket Screen", "/com/itm/food/views/Basket.fxml", BaseController.MAIN_SCREEN_WIDTH,
				BaseController.MAIN_SCREEN_HEIGHT);
	}

	void handleAddress() {
		this.launchScene("Address Screen", "/com/itm/food/views/Address.fxml", BaseController.MAIN_SCREEN_WIDTH,
				BaseController.MAIN_SCREEN_HEIGHT);
	}

	void handleCards() {
		this.launchScene("Cards Screen", "/com/itm/food/views/Cards.fxml", BaseController.MAIN_SCREEN_WIDTH,
				BaseController.MAIN_SCREEN_HEIGHT);
	}

	void handleProfile() {
		this.launchScene("Profile Screen", "/com/itm/food/views/Profile.fxml", BaseController.MAIN_SCREEN_WIDTH,
				BaseController.MAIN_SCREEN_HEIGHT);
	}
